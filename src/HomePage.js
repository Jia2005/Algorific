  ...
  return (
    <div className="card">
      ...
      <div className="face back">
        <h3>{title}</h3>
        <p>{description}</p>
        <button onClick={() => (window.location.href = learnLink)}>
          Learn
        </button>
        <button onClick={() => (window.location.href = playLink)}>
          Play a game
        </button>
      </div>
    </div>
  ...
  return (
    <div className="about-section">
      <div className="about-us-image">
        <img
          src="https://captura.ivi.int/wp-content/uploads/2023/08/WHO-We-Are.png"
          alt="About Us"
          className="imgabout"
      ...
      <div className="about-us-text">
        <p style={{ fontSize: "18px", color: "black", textAlign: "justify" }}>
          <br></br>
          <strong>Algorific</strong> is dedicated to making Data Science
          accessible and engaging for all. Our mission is to simplify complex
          Data Science concepts through high-quality animated courses that
          transform learning into an enjoyable adventure. Each lesson is
          designed to be engaging and easy to understand, incorporating
          interactive exercises and quizzes to enhance comprehension. We strive
          to make Data Science education available to everyone, regardless of
          their background, and aim to inspire the next generation of data
          scientists, analysts, and enthusiasts by merging animation with data
          science education.
        </p>
      </div>
    </div>
  ...
  return (
    <div className="contact-us">
      <section className="join-us-text">
        ...
        <p style={{ fontSize: "18px", color: "black", textAlign: "justify" }}>
          Are you passionate about building interactive and fun algorithms? We
          invite you to join our team and contribute to creating engaging,
          gamified learning experiences. Together, we can make learning data
          structures exciting and accessible for everyone!
        </p>
      </section>
    ...
    <div>
      ...
      <div className="logo">
        <a href="/home" className="navlogo">
          <div className="logoo" style={{ fontSize: "25px", color: "white" }}>
            ALGORIFIC
          </div>
        </a>
      </div>
